...
export const slides = [
  ...
  // 06 ────────────────────────────────────────────────────────────────────────
  {
    ...
    content: {
      ...
      rowOne: [
        { label: 'Hazard3 Core', sub: 'RV32IMAC · 36 MHz' },
        { label: 'JTAG DTM',     sub: 'hazard3_dm + DTM', style: { width: 269, margin: '0 0 0 -18px' } },
        { label: 'SRAM',         sub: 'ahb_sync_sram · 64 KB', style: { width: 769 } },
        { label: 'QSPI XIP cache', sub: 'peris/xip · ro_cache.v', variant: 'muted' },
      ],
      bus: 'AHB-Lite system bus · 32-bit · busfabric/',
      rowTwo: [
        { label: 'Conv1D Accel core', sub: 'peris/conv1d_accel · AHBL master', variant: 'accent', style: { width: 938.312 } },
        { label: 'APB bridge',        sub: 'AHBL → APB · control + status', style: { width: 657.656 } },
      ],
      peripherals: [
        { label: 'Conv1D config', sub: '0x4000_C000 · 7 regs' },
        { label: 'I²S RX + FIFO', sub: 'peris/i2s · INMP441' },
