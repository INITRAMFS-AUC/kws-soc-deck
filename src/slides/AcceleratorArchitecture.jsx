...
const STEPS = [
  {
    ...
    cap: 'Memory laid out · 4×4 input in SRAM · 2 weight words in XIP',
  },
  {
    fsm: 'S_IDLE',
    cpu: 'apb',
    ...
    wtLoaded: false, bufA: null, bufB: null,
    macSide: null, writes: 0,
    cap: 'CPU writes 7 config registers via APB',
  },
  {
    fsm: 'S_INIT',
    cpu: 'wfi',
    ...
    wtLoaded: false, bufA: null, bufB: null,
    macSide: null, writes: 0,
    cap: 'CTRL.START=1 · CPU issues WFI — pipeline halted',
  },
  {
    fsm: 'S_WT_DATA',
    cpu: 'wfi',
    ...
    macSide: null, writes: 0,
    cap: 'Load weights once — 2 words from XIP on the WORD path',
  },
  {
    fsm: 'S_BIAS / S_SHIFT',
    cpu: 'wfi',
    ...
    macSide: null, writes: 0,
    cap: 'Load bias and shift from SRAM',
  },
  {
    fsm: 'S_IN_DATA · w=0',
    cpu: 'wfi',
    ...
    macSide: null, writes: 0,
    cap: 'First input patch into BUF A',
  },
  {
    fsm: 'S_MAC_OVLP · w=0',
    cpu: 'wfi',
    ...
    macSide: 'A', writes: 1,
    cap: 'MAC on BUF A · parallel preload of BUF B · out[0] written',
  },
  {
    fsm: 'S_MAC_OVLP · w=1',
    cpu: 'wfi',
    ...
    macSide: 'B', writes: 2,
    cap: 'Roles swap · MAC on BUF B · BUF A reloads · out[1] written',
  },
  {
    fsm: 'S_MAC · w=2',
    cpu: 'wfi',
    ...
    macSide: 'A', writes: 3,
    cap: 'Last patch · no parallel load · out[2] written',
  },
  {
    fsm: 'S_DONE',
    cpu: 'wakes',
    ...
    cap: 'accel_done_irq · CPU wakes from WFI · acks · resumes',
  },
];
