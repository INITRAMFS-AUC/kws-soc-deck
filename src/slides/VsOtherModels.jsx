  ...
  return (
    <SlideFrame topLeft="12 · Model">
      <div ref={rootRef} style={{ marginTop: 36 }}>
        ...
        <h1 className="title" style={{ marginBottom: 12 }}>93.5 % accuracy at a fraction of the parameter count.</h1>
        <p className="subtitle" style={{ maxWidth: 1700, marginBottom: 28 }}>
          Google Speech Commands. We trade ~0.9 accuracy points against DS-CNN — our closest neighbour — for 2.4× fewer parameters and 5.6× fewer MACs.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 18 }}>
        <CalloutCard
          ...
          sub="7.6× fewer MACs · 4.0 pts lower accuracy"
        />
        <CalloutCard
          eyebrow="vs DS-CNN small"
          big="2.4× fewer params"
          sub="5.6× fewer MACs · 0.9 pts lower accuracy"
        />
        <CalloutCard
